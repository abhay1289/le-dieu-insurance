            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 md:mb-20 gap-6 md:gap-10">
               <div className="max-w-3xl">
                  ...
                  >
                     ...
                     <span className="text-sm font-extrabold tracking-[0.3em] text-accent uppercase">Institutional Grade</span>
                  </motion.div>
                  ...
                  <div className="overflow-hidden">
                     <motion.h2
                        ...
                        className="text-4xl sm:text-5xl md:text-[64px] font-heading font-extrabold text-primary tracking-tight leading-[1.15] mb-6"
                     >
                        Redefining <br />

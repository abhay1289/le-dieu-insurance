  ...
  return (
    <section className="py-20 bg-black relative overflow-hidden text-white">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16">
          <div>
            <div className="flex items-center gap-4 mb-8">
              <span className="uppercase tracking-[0.3em] text-[10px] font-bold text-white/60">Pricing Plans</span>
            </div>
            <h2 className="text-4xl sm:text-5xl md:text-[73px] font-bold text-white tracking-tighter leading-[0.9] max-w-4xl">
              Explore Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-400 to-white font-bold">Insurance Plans</span>
            </h2>
          </div>
        ...
        {/* Plan Types Tabs */}
        <div className="bg-white rounded-[40px] overflow-hidden p-2 text-black">
                  ...
                  <ul className="space-y-4 mb-10">
                    {['Cashless hospital access.', 'Affordable premiums.', 'Mental health support.', '24/7 Virtual doctor visits.'].map((item, i) => (
                      <li key={i} className="flex items-center gap-3 text-gray-700">
                        <div className="w-1 h-px bg-black/20"></div> // Changed from w-4 for consistency
                        {item}
                      </li>
                    ))}
                  </ul>
                  <a href="/services" className="inline-flex items-center gap-2 bg-black text-white px-8 py-4 rounded-full font-semibold hover:bg-black transition-colors">

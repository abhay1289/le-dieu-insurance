    ...
    <section id="services" className="py-16 md:py-32 bg-white overflow-hidden">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-8 md:mb-10 gap-6 md:gap-12 border-b border-gray-100 pb-6 md:pb-8">
            ...
            <div className="mb-2">
              ...
              <div className="overflow-hidden py-2">
                <motion.div variants={textRevealVariants} className="flex flex-col">
                  <span className="text-black text-4xl sm:text-5xl md:text-[73px] font-bold tracking-tighter leading-[0.9]">Risk Engineering</span>
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-black via-neutral-600 to-neutral-400 text-4xl sm:text-5xl md:text-[73px] font-bold tracking-tighter leading-[0.9]">Insurance Solutions</span>
                </motion.div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <a href="#services" className="group flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.2em] text-black hover:text-neutral-600 transition-all">
              <span className="border-b border-gray-200 group-hover:border-neutral-600 pb-1">View All Solutions</span>

      ...
      <div className="container mx-auto px-6 md:px-12 relative z-20 h-full flex flex-col justify-center">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center h-full pt-32 md:pt-20 pb-16 md:pb-0">
          ...
          >
            ...
            >
              <a href="/get-started" className="h-14 px-8 bg-white text-black rounded-full font-semibold text-lg hover:bg-gray-200 active:scale-95 active:shadow-none transition-all flex items-center gap-2 hover:scale-105 transform duration-300 shadow-[0_0_20px_rgba(255,255,255,0.2)]">

                Get Protected <ArrowIcon className="w-4 h-4" />
              </a>

              <a href="/services" className="group flex items-center gap-2 text-white text-lg font-medium hover:text-white/80 active:text-white transition-colors px-4">

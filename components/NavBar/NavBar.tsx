          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-6 border-b border-gray-50">
              ...
              <button
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-50 text-primary"
                aria-label="Close Menu"
              >
                <div className="relative w-5 h-5">
                  <span className="absolute top-1/2 left-0 w-5 h-[1.5px] bg-current rotate-45 -translate-y-1/2"></span>
                  <span className="absolute top-1/2 left-0 w-5 h-[1.5px] bg-current -rotate-45 -translate-y-1/2"></span>
                </div>
              </button>
            </div>

    ...
    <footer className="bg-primary text-white pt-32 pb-12 overflow-hidden relative">
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <motion.div 
          ...
          className="flex flex-col lg:flex-row justify-between items-start gap-16 mb-24"
        >
           <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium max-w-3xl tracking-tighter leading-[1]">
             We’ll Find the Right <span className="text-accent italic font-serif">Insurance</span> for You.
           </h2>
           
           <div className="flex flex-col sm:flex-row gap-16 lg:items-center">
              <div>
                 <p className="text-white/40 mb-3 text-[10px] uppercase tracking-[0.2em] font-bold">Phone</p>
                 <a href="tel:+919876543210" className="text-2xl font-light hover:text-accent transition-colors">+91 98765 43210</a>
              </div>
              <div>
                 <p className="text-white/40 mb-3 text-[10px] uppercase tracking-[0.2em] font-bold">Email</p>
                 <a href="mailto:info@ledieu.com" className="text-2xl font-light hover:text-accent transition-colors">info@ledieu.com</a>
              </div>
           </div>
        </motion.div>
        ...
        >
           <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} className="space-y-8">
              <a href="/" className="block">
                 <span className="font-sans text-2xl font-bold text-white tracking-tight">Le Dieu</span>
              </a>
              <p className="text-white/60 leading-relaxed text-sm font-light max-w-xs">
           ...
           <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
              <h4 className="text-sm font-bold uppercase tracking-widest mb-8">Main Pages</h4>
           ...
           <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
              <h4 className="text-sm font-bold uppercase tracking-widest mb-8">CMS Pages</h4>
              <ul className="space-y-4 text-white/60 text-sm font-medium">
           ...
           <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
              <h4 className="text-sm font-bold uppercase tracking-widest mb-8">Information</h4>
              <ul className="space-y-4 text-white/60 text-sm font-medium">
        ...
        <motion.div 
           ...
           className="absolute bottom-[-5%] left-0 w-full text-center font-bold text-[18vw] leading-none select-none pointer-events-none text-white tracking-tighter"
        >
           <span>Le Dieu</span>
        </motion.div>

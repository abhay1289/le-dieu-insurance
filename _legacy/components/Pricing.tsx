        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          <div>
            <div className="flex items-center gap-3 mb-4">
               <span className="uppercase tracking-widest text-sm font-medium text-white/70">Pricing Plan</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold max-w-2xl">
              Explore Our <span className="text-accent italic">Insurance Plans</span> That Work for You
            </h2>
          </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="relative h-[400px] rounded-3xl overflow-hidden">
                     <img src={images[activePlan]} alt={activePlan} className="absolute inset-0 w-full h-full object-cover" />
                  </div>
                </motion.div>
              </AnimatePresence>
           </div>

        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 mb-24 items-center">
           ...
           >
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="uppercase tracking-widest text-sm font-bold text-primary">Our Legacy</span>
              </div>
              <h2 className="text-4xl md:text-6xl font-bold text-primary leading-[1.1] mb-8">
                Founded on Trust. <br/>
                <span className="text-gray-400 italic">Built for Eternity.</span>
              </h2>

                ...
                <div className="relative z-10 container mx-auto px-6 md:px-12 py-24 md:py-32">
                    <div className="grid lg:grid-cols-2 gap-20">
                        ...
                        <div className="lg:sticky lg:top-32 h-fit">
                            <span className="text-white/60 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">Communication Channels</span>
                            <h2 className="text-5xl md:text-7xl font-bold tracking-tighter mb-8 leading-none">
                                Let's Engineer <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">Your Shield.</span>
                            </h2>
                                ...
                                {offices.map((office, i) => (
                                    <div key={i} className="group p-8 rounded-3xl bg-white/5 border border-white/5 hover:border-white/30 hover:bg-white/10 transition-all duration-500">
                                        <div className="flex justify-between items-start mb-4">
                                            <div>
                                                <div className="text-white/40 text-[10px] font-bold uppercase tracking-[0.2em] mb-1">{office.label}</div>
                        ...
                        {/* Right Column - Form */}
                        <div className="bg-neutral-900 p-8 md:p-12 rounded-[3rem] border border-white/5 relative overflow-hidden">
                            ...
                            <form onSubmit={handleSubmit} className="relative z-10 space-y-8">
                                <div className="space-y-6">
                                    <div className="relative group">
                                        <label className="text-white/40 text-xs font-bold uppercase tracking-widest mb-2 block group-focus-within:text-white transition-colors">Identity</label>
                                        <input
                                            type="text"
                                            name="name"
                                            value={formData.name}
                                            ...
                                            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-white placeholder:text-white/20 focus:outline-none focus:border-white/50 focus:bg-white/10 transition-all font-mono text-sm"
                                        />
                                    </div>

                                    <div className="relative group">
                                        <label className="text-white/40 text-xs font-bold uppercase tracking-widest mb-2 block group-focus-within:text-white transition-colors">Coordinates</label>
                                        <input
                                            type="email"
                                            name="email"
                                    ...
                                    <div className="relative group">
                                        <label className="text-white/40 text-xs font-bold uppercase tracking-widest mb-2 block group-focus-within:text-white transition-colors">Organization</label>
                                        <input
                                            type="text"
                                            name="company"
                                    ...
                                    <div className="relative group">
                                        <label className="text-white/40 text-xs font-bold uppercase tracking-widest mb-2 block group-focus-within:text-white transition-colors">Objective</label>
                                        <textarea
                                            name="message"
                                ...
                                <button type="submit" className="w-full bg-white text-black py-5 rounded-xl font-bold uppercase tracking-widest hover:bg-white/90 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-all duration-300">
                                    Initiate Protocol
                                </button>

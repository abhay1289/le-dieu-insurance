                ...
                <div className="relative z-10 container mx-auto px-6 md:px-12 py-24 md:py-32">
                    <div className="grid lg:grid-cols-2 gap-20">
                        ...
                        <div className="lg:sticky lg:top-32 h-fit">
                            <span className="text-accent text-xs font-bold uppercase tracking-[0.3em] mb-4 block">Communication Channels</span>
                            <h2 className="text-5xl md:text-7xl font-bold tracking-tighter mb-8 leading-none">
                                Let's Engineer <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-white">Your Shield.</span>
                            </h2>
                            ...
                            <div className="space-y-8">
                                {offices.map((office, i) => (
                                    <div key={i} className="group p-8 rounded-3xl bg-white/5 border border-white/5 hover:border-accent/30 hover:bg-white/10 transition-all duration-500">
                                        <div className="flex justify-between items-start mb-4">
                                            <div>
                                                <div className="text-accent text-[10px] font-bold uppercase tracking-[0.2em] mb-1">{office.label}</div>
                                        ...
                                        <div className="flex flex-col gap-2 text-sm font-mono text-white/40">
                                            <span className="hover:text-accent cursor-pointer transition-colors">{office.phone}</span>
                                            <span className="hover:text-accent cursor-pointer transition-colors">{office.email}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        {/* Right Column - Form */}
                        <div className="bg-[#0B1C15] p-8 md:p-12 rounded-[3rem] border border-white/5 relative overflow-hidden">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-4 text-white placeholder:text-white/20 focus:outline-none focus:border-accent/50 focus:bg-white/10 transition-all font-mono text-sm resize-none"
                                        />
                                    </div>
                                </div>

                                <button type="submit" className="w-full bg-accent text-black py-5 rounded-xl font-bold uppercase tracking-widest hover:bg-white hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-all duration-300">
                                    Initiate Protocol
                                </button>

                            ...
                            >
                                ...
                                <div className="space-y-2 mb-10">
                                    <div className="overflow-hidden">
                                        <motion.h2 variants={textRevealVariants} className="text-4xl sm:text-5xl md:text-[64px] font-bold tracking-tight leading-[1.15] text-primary">
                                            Beyond
                                        </motion.h2>
                                    </div>
                                    <div className="overflow-hidden">
                                        <motion.h2 variants={textRevealVariants} className="text-4xl sm:text-5xl md:text-[64px] font-bold tracking-tight leading-[1.15] text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary/80 to-accent">
                                            Insurance.
                                        </motion.h2>
                                    </div>
                                </div>

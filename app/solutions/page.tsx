...
const industrySolutions = [
    {
        ...
        icon: <FactoryIcon />,
        description: "In the high-stakes arena of heavy manufacturing, a single second of operational downtime is more than just a logistical hurdle—it is a catastrophic financial leak that can erode years of profitability in an afternoon. We specialize in architecting multi-layered safety nets that go far beyond standard insurance placement. Our frameworks are specifically engineered to neutralize risks associated with complex machinery breakdowns, intricate supply chain disruptions, and large-scale business interruptions that threaten the very core of your industrial output. By conducting deep-dive technical audits and stress-testing your current risk exposure, we ensure that your factory stays resilient against both predictable failures and the black-swan events of the global market. We prioritize your balance sheet as much as your machinery, providing a resilient financial chassis for the industries that power the nation's future Growth and economic stability.",
    ...
    },
    {
        ...
        icon: <CraneIcon />,
        description: "Engineering mega-projects requires a risk management foundation as solid as the concrete in your bridges and tunnels. From initial ground-breaking to final ribbon-cutting, we provide surgical, end-to-end coverage for roads, highways, and civil engineering marvels that form the backbone of national progress. Our strategic focus is on protecting your enterprise against project delays, material damage, and complex third-party liabilities that arise during staggered lifecycle transitions. We understand the volatility of EPC contracts and the regulatory shifts inherent in Indian infrastructure development. By building bespoke transfer mechanisms, we shield your capital and your reputation from the unforeseen geological and financial tremors that often destabilize the world's most ambitious construction projects. We ensure that your engineers can focus on building the future, while we manage the unseen forces that threaten project completion and your long-term operational success.",
    ...
    },
    {
        ...
        icon: <BoltIcon />,
        description: "As India transitions toward a more complex and decentralized energy grid, the threats facing the power sector have decoupled from traditional risk models. Whether you are managing the base-load stability of a thermal giant or the weather-dependent volatility of a sprawling solar park, your risk transfer mechanism must be as dynamic as the energy you generate. We architect specialized 'Mega Risk' policies that guard against grid interruptions, internal technical failures, and the rising frequency of natural catastrophes. Our narrative-led approach ensures that every kilowatt—from hydro-pumping stations to wind turbine arrays—is protected by a resilient financial chassis. We empower you to lead the energy transition with confidence, knowing that your operational uptime and environmental liabilities are managed by elite risk engineers who understand the intricate physics of the power sector and the evolving regulatory landscape of the Indian energy market's future roadmap.",
    ...
    },
    {
        ...
        icon: <BriefcaseIcon />,
        description: "In an era of rising litigiousness and sophisticated digital warfare, corporate decision-makers face an unprecedented landscape of personal and professional exposure. We act as the strategic architect for your organization's ethical and financial reputation, shielding the collective brain of the company from modern vectors of failure. Our liability solutions are designed to protect Directors and Officers from personal ruin while simultaneously fortifying the corporate balance sheet against cyber ransomware, data breaches, and systemic errors in professional judgment. We move beyond the fine print to build a sophisticated fortress around your boardroom, ensuring that your leadership can navigate complex regulatory environments and high-stakes transitions without the paralyzing fear of crippling litigation or reputational collapse. We treat your corporate governance as an asset to be protected with the highest level of fiduciary care and elite underwriting globally for your sustained leadership excellence.",
    ...
    },
    {
        ...
        description: "Operating a modern healthcare institution requires managing a delicate duality: the maintenance of cutting-edge diagnostic infrastructure and the protection of sensitive human lives. Our healthcare risk protocols are built on a foundation of clinical excellence and patient-centric safety. We design specialized medical malpractice and equipment breakdown frameworks that prioritize operational continuity above all else. In a landscape where a single clinical error can trigger a microscopic audit of your entire enterprise, we provide the financial and legal bedrock necessary to keep your facility focused on healing. From shielding your high-value MRI suites from technical failure to managing the complex liabilities of clinical trials, our bespoke solutions ensure that your hospital remains a trusted pillar of the community, safe from the volatile financial shocks of modern healthcare litigation and technological breakdown in an evolving global landscape.",
    ...
    },
    {
        ...
        icon: <BedIcon />,
        description: "Building a globally recognized hospitality brand takes decades of meticulous service, yet a single unforeseen incident can tarnish that reputation in a matter of hours. We specialize in creating 360-degree safety nets for premium hotel chains and boutique resorts that prioritize both guest assurance and asset resilience. Our frameworks cover the physical grandeur of your properties against fire, theft, and natural disasters while ensuring that your guests' safety and your brand's integrity remain unshakeable. We manage the intricate liabilities inherent in food services, liquor protocols, and public accessibility, providing a seamless layer of protection that operates invisibly in the background. By shielding your property from asset loss and business interruption, we allow you to focus on the art of luxury and guest satisfaction, knowing that your financial future is secured against the unique volatility and challenges of the global tourism industry.",
                                                    ...
                                                    <div className="relative grid lg:grid-cols-2 gap-12 md:gap-20 pt-16 pb-12">
                                                        ...
                                                        <div>
                                                            ...
                                                            <motion.h3
                                                                ...
                                                                className="text-xl md:text-3xl text-primary font-bold leading-[1.4] mb-10 tracking-tight max-w-2xl text-justify"
                                                            >

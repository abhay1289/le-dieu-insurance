...
const industrySolutions = [
    {
        ...
        icon: <FactoryIcon />,
        description: "In heavy manufacturing, a single second of downtime is a catastrophic financial leak that can erode years of profitability. We specialize in architecting multi-layered safety nets that go far beyond standard insurance placement. Our frameworks are engineered to neutralize risks associated with machinery breakdowns, supply chain disruptions, and large-scale business interruptions that threaten your industrial output. By conducting technical audits and stress-testing your risk exposure, we ensure your factory stays resilient against predictable failures and black-swan events. We prioritize your balance sheet as much as your machinery, providing a resilient financial chassis for the industries that power the nation's future growth and economic stability.",
    ...
    },
    {
        ...
        icon: <CraneIcon />,
        description: "Engineering mega-projects requires a risk management foundation as solid as the concrete in your bridges. From ground-breaking to ribbon-cutting, we provide surgical coverage for roads and civil engineering marvels that form the backbone of national progress. Our focus is on protecting your enterprise against project delays, material damage, and complex third-party liabilities during lifecycle transitions. We understand the volatility of EPC contracts and the regulatory shifts inherent in infrastructure development. By building bespoke transfer mechanisms, we shield your capital and reputation from the unforeseen geological and financial tremors that can destabilize ambitious projects. We ensure your engineers can focus on building the future, while we manage the unseen forces that threaten project completion.",
    ...
    },
    {
        ...
        icon: <BoltIcon />,
        description: "As India transitions toward a complex energy grid, the threats facing the power sector have decoupled from traditional risk models. Whether you manage the base-load stability of a thermal giant or the volatility of a solar park, your risk transfer mechanism must be as dynamic as the energy you generate. We architect specialized 'Mega Risk' policies that guard against grid interruptions, technical failures, and natural catastrophes. Our narrative-led approach ensures that every kilowatt—from hydro stations to wind arrays—is protected by a resilient financial chassis. We empower you to lead the energy transition with confidence, knowing your operational uptime and environmental liabilities are managed by elite engineers who understand the intricate physics and the evolving regulatory landscape.",
    ...
    },
    {
        ...
        icon: <BriefcaseIcon />,
        description: "In an era of rising litigation and digital warfare, corporate decision-makers face an unprecedented landscape of professional exposure. We act as the strategic architect for your organization's reputation, shielding the collective brain of the company from modern vectors of failure. Our liability solutions protect Directors and Officers from personal ruin while fortifying the balance sheet against cyber ransomware, data breaches, and systemic errors in judgment. We move beyond the fine print to build a sophisticated fortress around your boardroom, ensuring your leadership can navigate complex regulatory environments without the fear of crippling litigation or reputational collapse. We treat your corporate governance as an asset to be protected with the highest level of care and elite underwriting globally.",
    ...
    },
    {
        ...
        description: "Operating a modern healthcare institution requires managing a delicate duality: the maintenance of diagnostic infrastructure and the protection of sensitive human lives. Our healthcare risk protocols are built on clinical excellence and patient-centric safety. We design medical malpractice and equipment breakdown frameworks that prioritize operational continuity. In a landscape where clinical errors can trigger microscopic audits, we provide the financial and legal bedrock necessary to keep your facility focused on healing. From shielding high-value diagnostic suites to managing the liabilities of clinical trials, our bespoke solutions ensure your hospital remains a trusted pillar of the community, safe from the volatile financial shocks of modern healthcare litigation and technological breakdown in an evolving world.",
    ...
    },
    {
        ...
        icon: <BedIcon />,
        description: "Building a globally recognized hospitality brand takes decades of meticulous service, yet a single incident can tarnish that reputation in hours. We specialize in creating 360-degree safety nets for premium hotel chains and boutique resorts that prioritize guest assurance and asset resilience. Our frameworks cover the physical grandeur of your properties against disasters while ensuring guest safety and brand integrity remain unshakeable. We manage the intricate liabilities inherent in specialty services, providing a seamless layer of protection that operates invisibly. By shielding your property from asset loss and business interruption, we allow you to focus on luxury and guest satisfaction, knowing your financial future is secured against the unique volatility of the global tourism and leisure industry.",
                                                    ...
                                                    <div className="relative grid lg:grid-cols-2 gap-12 md:gap-20 pt-16 pb-12">
                                                        ...
                                                        <div>
                                                            ...
                                                            <motion.h3
                                                                ...
                                                                className="text-xl md:text-3xl text-primary font-bold leading-[1.4] mb-10 tracking-tight max-w-2xl"
                                                            >

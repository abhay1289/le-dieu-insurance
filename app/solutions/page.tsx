...
const industrySolutions = [
    {
        ...
        icon: <FactoryIcon />,
        description: "In heavy manufacturing, even brief downtime is a catastrophic leak that silently erodes years of hard-won profitability. We architect robust, multi-layered safety nets that go far beyond standard insurance coverage. Our specialized frameworks neutralize risks from critical machinery breakdowns and operational interruptions. By stress-testing your total exposure, we ensure resilience.",
        features: [
    ...
    },
    {
        ...
        icon: <CraneIcon />,
        description: "Engineering mega-projects demands risk management foundations as solid as the bridges you build across India. From ground-breaking to completion, we provide surgical coverage for ambitious civil engineering marvels nationwide. Our core focus is protecting your enterprise against costly project delays and material damage. We architect bespoke risk transfer mechanisms effectively.",
        features: [
    ...
    },
    {
        ...
        icon: <BoltIcon />,
        description: "As India transitions toward a complex energy grid, power sector threats have decoupled from traditional risk models entirely. Whether managing a thermal giant or a solar park, your risk strategy must be dynamic. We architect specialized policies guarding against grid interruptions. Our tailored approach ensures every kilowatt generated is protected.",
        features: [
    ...
    },
    {
        ...
        icon: <BriefcaseIcon />,
        description: "In an era of rising litigation and relentless digital warfare, corporate leaders face unprecedented personal and professional exposure. We act as the strategic architect for your leadership's reputation, shielding the brain trust from failure. Our liability solutions protect Directors and Officers from ruin across all jurisdictions while neutralizing cyber threats.",
        features: [
    ...
    },
    {
        ...
        description: "Operating a modern healthcare institution demands managing advanced diagnostic tools alongside the vital protection of human lives. Our risk protocols are built on strong foundations of clinical excellence and patient safety. We design medical malpractice and equipment breakdown frameworks that prioritize operational continuity. Our bespoke solutions safeguard your institutional integrity.",
        features: [
    ...
    },
    {
        ...
        icon: <BedIcon />,
        description: "Building a recognized hospitality brand takes decades of impeccable service, yet a single uninsured incident can tarnish that reputation overnight. We create comprehensive safety nets for elite hotel chains prioritizing guest assurance and asset resilience. Our frameworks protect property and brand integrity. We strategically shield every operational asset for excellence.",
        features: [
                                                            ...
                                                            <div className="flex flex-col justify-between h-full">
                                                                <div>
                                                                    ...
                                                                    <motion.h3
                                                                        ...
                                                                        className="text-base md:text-xl text-primary font-bold leading-[1.6] mb-10 tracking-tight max-w-lg"
                                                                    >
                                                                    ...
                                                                    <div className="relative rounded-2xl md:rounded-[2rem] overflow-hidden aspect-[4/5] shadow-2xl">
                                                                        ...
                                                                        >
                                                                            <div className="flex items-center gap-3 mb-3">
                                                                                <span className="text-white text-xs font-extrabold uppercase tracking-[0.3em]">{solution.subtitle}</span>
                                                                            </div>
